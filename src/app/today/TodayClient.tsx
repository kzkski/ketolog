  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col min-h-0">
        {/* 日付ナビゲーション */}
        <div className="flex-none flex items-center justify-between px-2.5 sm:px-4 py-1 sm:py-2 border-b border-gray-800 bg-gray-900 gap-1 sm:gap-2">
          <button type="button" onClick={() => navigateDate(-1)} disabled={loadingDate}
            className="min-h-9 min-w-9 sm:min-h-8 sm:min-w-8 flex items-center justify-center text-gray-400 hover:text-white disabled:opacity-30 transition-colors text-lg sm:text-lg rounded-lg sm:rounded-none active:bg-gray-800/50 shrink-0">
            ‹
          </button>
          <div className="flex flex-row sm:flex-col flex-wrap items-center justify-center gap-x-1.5 gap-y-0 sm:gap-1 min-w-0 flex-1 px-0.5">
